...
# ifdef __COMPILING_ADSK_CORE_CURVEEVALUATOR3D_CPP__
# define ADSK_CORE_CURVEEVALUATOR3D_API XI_EXPORT
# else
# define ADSK_CORE_CURVEEVALUATOR3D_API
# endif
#else
# define ADSK_CORE_CURVEEVALUATOR3D_API XI_IMPORT
#endif
...
class CurveEvaluator3D : public Base {
public:
    ...
    bool getCurvatures(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& directions, std::vector<double>& curvatures) const;
    ...
    bool getCurvature(double parameter, Ptr<Vector3D>& direction, double& curvature) const;
    ...
    bool getEndPoints(Ptr<Point3D>& startPoint, Ptr<Point3D>& endPoint) const;
    ...
    bool getParametersAtPoints(const std::vector<Ptr<Point3D>>& points, std::vector<double>& parameters) const;
    ...
    bool getParameterAtPoint(const Ptr<Point3D>& point, double& parameter) const;
    ...
    bool getPointsAtParameters(const std::vector<double>& parameters, std::vector<Ptr<Point3D>>& points) const;
    ...
    bool getPointAtParameter(double parameter, Ptr<Point3D>& point) const;
    ...
    bool getFirstDerivatives(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& firstDerivatives) const;
    ...
    bool getFirstDerivative(double parameter, Ptr<Vector3D>& firstDerivative) const;
    ...
    bool getSecondDerivatives(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& secondDerivatives) const;
    ...
    bool getSecondDerivative(double parameter, Ptr<Vector3D>& secondDerivative) const;
    ...
    bool getThirdDerivatives(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& thirdDerivatives) const;
    ...
    bool getThirdDerivative(double parameter, Ptr<Vector3D>& thirdDerivative) const;
    ...
    bool getStrokes(double fromParameter, double toParameter, double tolerance, std::vector<Ptr<Point3D>>& vertexCoordinates) const;
    ...
    bool getTangents(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& tangents) const;
    ...
    bool getTangent(double parameter, Ptr<Vector3D>& tangent) const;

    ADSK_CORE_CURVEEVALUATOR3D_API static const char* classType();
    ADSK_CORE_CURVEEVALUATOR3D_API const char* objectType() const override;
    ADSK_CORE_CURVEEVALUATOR3D_API void* queryInterface(const char* id) const override;
    ADSK_CORE_CURVEEVALUATOR3D_API static const char* interfaceId() { return classType(); }

private:

    // Raw interface
    virtual bool getCurvatures_raw(const double* parameters, size_t parameters_size, Vector3D**& directions, size_t& directions_size, double*& curvatures, size_t& curvatures_size) const = 0;
    virtual bool getCurvature_raw(double parameter, Vector3D*& direction, double& curvature) const = 0;
    virtual bool getEndPoints_raw(Point3D*& startPoint, Point3D*& endPoint) const = 0;
    ...
    virtual bool getParametersAtPoints_raw(Point3D** points, size_t points_size, double*& parameters, size_t& parameters_size) const = 0;
    virtual bool getParameterAtPoint_raw(Point3D* point, double& parameter) const = 0;
    virtual bool getParameterExtents_raw(double& startParameter, double& endParameter) const = 0;
    virtual bool getPointsAtParameters_raw(const double* parameters, size_t parameters_size, Point3D**& points, size_t& points_size) const = 0;
    virtual bool getPointAtParameter_raw(double parameter, Point3D*& point) const = 0;
    virtual bool getFirstDerivatives_raw(const double* parameters, size_t parameters_size, Vector3D**& firstDerivatives, size_t& firstDerivatives_size) const = 0;
    virtual bool getFirstDerivative_raw(double parameter, Vector3D*& firstDerivative) const = 0;
    virtual bool getSecondDerivatives_raw(const double* parameters, size_t parameters_size, Vector3D**& secondDerivatives, size_t& secondDerivatives_size) const = 0;
    virtual bool getSecondDerivative_raw(double parameter, Vector3D*& secondDerivative) const = 0;
    virtual bool getThirdDerivatives_raw(const double* parameters, size_t parameters_size, Vector3D**& thirdDerivatives, size_t& thirdDerivatives_size) const = 0;
    virtual bool getThirdDerivative_raw(double parameter, Vector3D*& thirdDerivative) const = 0;
    virtual bool getStrokes_raw(double fromParameter, double toParameter, double tolerance, Point3D**& vertexCoordinates, size_t& vertexCoordinates_size) const = 0;
    virtual bool getTangents_raw(const double* parameters, size_t parameters_size, Vector3D**& tangents, size_t& tangents_size) const = 0;
    virtual bool getTangent_raw(double parameter, Vector3D*& tangent) const = 0;
};

// Inline wrappers

inline bool CurveEvaluator3D::getCurvatures(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& directions, std::vector<double>& curvatures) const
{
    Vector3D** directions_ = nullptr;
...
inline bool CurveEvaluator3D::getCurvature(double parameter, Ptr<Vector3D>& direction, double& curvature) const
{
...
inline bool CurveEvaluator3D::getEndPoints(Ptr<Point3D>& startPoint, Ptr<Point3D>& endPoint) const
{
...
inline bool CurveEvaluator3D::getLengthAtParameter(double fromParameter, double toParameter, double& length) const
{
    bool res = getLengthAtParameter_raw(fromParameter, toParameter, length);
    return res;
}

inline bool CurveEvaluator3D::getParameterAtLength(double fromParameter, double length, double& parameter) const
{
    bool res = getParameterAtLength_raw(fromParameter, length, parameter);
    return res;
}

inline bool CurveEvaluator3D::getParametersAtPoints(const std::vector<Ptr<Point3D>>& points, std::vector<double>& parameters) const
{
...
inline bool CurveEvaluator3D::getParameterAtPoint(const Ptr<Point3D>& point, double& parameter) const
{
    bool res = getParameterAtPoint_raw(point.get(), parameter);
    return res;
}

inline bool CurveEvaluator3D::getParameterExtents(double& startParameter, double& endParameter) const
{
    bool res = getParameterExtents_raw(startParameter, endParameter);
    return res;
}

inline bool CurveEvaluator3D::getPointsAtParameters(const std::vector<double>& parameters, std::vector<Ptr<Point3D>>& points) const
{
...
inline bool CurveEvaluator3D::getPointAtParameter(double parameter, Ptr<Point3D>& point) const
{
...
inline bool CurveEvaluator3D::getFirstDerivatives(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& firstDerivatives) const
{
    Vector3D** firstDerivatives_ = nullptr;
...
inline bool CurveEvaluator3D::getFirstDerivative(double parameter, Ptr<Vector3D>& firstDerivative) const
{
    Vector3D* firstDerivative_ = nullptr;
...
inline bool CurveEvaluator3D::getSecondDerivatives(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& secondDerivatives) const
{
    Vector3D** secondDerivatives_ = nullptr;
...
inline bool CurveEvaluator3D::getSecondDerivative(double parameter, Ptr<Vector3D>& secondDerivative) const
{
    Vector3D* secondDerivative_ = nullptr;
...
inline bool CurveEvaluator3D::getThirdDerivatives(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& thirdDerivatives) const
{
    Vector3D** thirdDerivatives_ = nullptr;
...
inline bool CurveEvaluator3D::getThirdDerivative(double parameter, Ptr<Vector3D>& thirdDerivative) const
{
    Vector3D* thirdDerivative_ = nullptr;
...
inline bool CurveEvaluator3D::getStrokes(double fromParameter, double toParameter, double tolerance, std::vector<Ptr<Point3D>>& vertexCoordinates) const
{
    Point3D** vertexCoordinates_ = nullptr;
...
inline bool CurveEvaluator3D::getTangents(const std::vector<double>& parameters, std::vector<Ptr<Vector3D>>& tangents) const
{
    Vector3D** tangents_ = nullptr;
...
inline bool CurveEvaluator3D::getTangent(double parameter, Ptr<Vector3D>& tangent) const
{
    Vector3D* tangent_ = nullptr;
...
#undef ADSK_CORE_CURVEEVALUATOR3D_API