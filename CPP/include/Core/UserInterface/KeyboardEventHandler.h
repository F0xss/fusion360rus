...
# ifdef __COMPILING_ADSK_CORE_KEYBOARDEVENTHANDLER_CPP__
# define ADSK_CORE_KEYBOARDEVENTHANDLER_API XI_EXPORT
# else
# define ADSK_CORE_KEYBOARDEVENTHANDLER_API
# endif
#else
# define ADSK_CORE_KEYBOARDEVENTHANDLER_API XI_IMPORT
#endif
...
public:
    ...
    ADSK_CORE_KEYBOARDEVENTHANDLER_API virtual void notify(const Ptr<KeyboardEventArgs>& eventArgs) = 0;
};

}// namespace core
}// namespace adsk

#undef ADSK_CORE_KEYBOARDEVENTHANDLER_API