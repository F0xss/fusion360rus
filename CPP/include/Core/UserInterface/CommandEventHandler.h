...
# ifdef __COMPILING_ADSK_CORE_COMMANDEVENTHANDLER_CPP__
# define ADSK_CORE_COMMANDEVENTHANDLER_API XI_EXPORT
# else
# define ADSK_CORE_COMMANDEVENTHANDLER_API
# endif
#else
# define ADSK_CORE_COMMANDEVENTHANDLER_API XI_IMPORT
#endif
...
public:
    ...
    ADSK_CORE_COMMANDEVENTHANDLER_API virtual void notify(const Ptr<CommandEventArgs>& eventArgs) = 0;
};

}// namespace core
}// namespace adsk

#undef ADSK_CORE_COMMANDEVENTHANDLER_API