...
# ifdef __COMPILING_ADSK_CORE_VALIDATEINPUTSEVENTHANDLER_CPP__
# define ADSK_CORE_VALIDATEINPUTSEVENTHANDLER_API XI_EXPORT
# else
# define ADSK_CORE_VALIDATEINPUTSEVENTHANDLER_API
# endif
#else
# define ADSK_CORE_VALIDATEINPUTSEVENTHANDLER_API XI_IMPORT
#endif
...
class ValidateInputsEventHandler : public EventHandler {
public:
    ...
    ADSK_CORE_VALIDATEINPUTSEVENTHANDLER_API virtual void notify(const Ptr<ValidateInputsEventArgs>& eventArgs) = 0;
};

}// namespace core
}// namespace adsk

#undef ADSK_CORE_VALIDATEINPUTSEVENTHANDLER_API